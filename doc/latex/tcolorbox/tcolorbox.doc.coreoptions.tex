...
\begin{docTcbKey}{overlay first and middle}{=\meta{graphical code}}{no default, initially unset}
  This is an optimized abbreviation for setting
...
\begin{docTcbKey}{every float}{=\meta{code}}{no default, initially empty}
...
\begin{docTcbKey}{list text}{=\meta{text}}{style, no default}
