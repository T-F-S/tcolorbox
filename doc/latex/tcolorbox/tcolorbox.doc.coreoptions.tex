...
%\begin{docTcbKey}[][doc new=2015-05-07]{halign}{=\meta{alignment}}{no default, initially \texttt{justify}}
  ...
  \item\docValue{justify}: usual left and right justified type setting.
    Actually, this setting does nothing.
...
\begin{marker}
For nested boxes, \docValue{left}, \docValue{right}, \docValue{center} from an outer box
destroy the justification \docValue{justify} from inner boxes, while
\docValue{flush left}, \docValue{flush right}, \docValue{flush center}
do not. For further justification options, see example at \refKey{/tcb/halign code} .
\end{marker}
...
\begin{docTcbKeys}[
  ...
  e.\,g.\ using alignments from specialized packages, e.\,g.\ \refPkg{ragged2e}.

\begin{exdispExample}{halign_code}
% \usepackage{ragged2e}
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,halign=center]
  Some centered text.
  \begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,width=5cm,
      halign code=\noindent\justifying]
...
\begin{exdispExample}{halign_code_2}
% \usepackage{ragged2e}
\tcbset{colback=red!5!white,colframe=red!75!black,size=small,
  fonttitle=\bfseries,width=3.5cm,box align=top,
  nobeforeafter}

\begin{tcolorbox}[adjusted title=Centering,halign code=\Centering]
This is a demonstration text for showing how line breaking works.
\end{tcolorbox}
\begin{tcolorbox}[adjusted title=RaggedRight,halign code=\RaggedRight]
This is a demonstration text for showing how line breaking works.
\end{tcolorbox}
\begin{tcolorbox}[adjusted title=RaggedLeft,halign code=\RaggedLeft]
This is a demonstration text for showing how line breaking works.
\end{tcolorbox}
\end{exdispExample}
...
See \zvref{subsec:watermarks} if
...
\begin{marker}
All following vertical spread options are not suitable for breakable boxes!
\end{marker}
...
\end{itemize}
Examples for the |phantom| usage are given in \zvref{listing:exercises}, e.\,g.\
...
Typically, this option is used for numbered boxes, see \zvref{sec:numberedboxes}, e.\,g.\ \refKey{/tcb/new/auto counter}.
\end{docTcbKey}
...
\begin{docTcbKey}[][doc new=2017-02-10]{bookmark}{=\meta{text}}{no default, initially unset}
  ...
  is loaded. Otherwise, this option is silently ignored.
  This bookmark is set with an automated destination (the current box)
...
\begin{docTcbKey}[][doc new=2017-02-10]{bookmark*}{=\marg{options}\marg{text}}{no default, initially unset}
  ...
  If the package \refPkg{bookmark} \cite{oberdiek:bookmark} is not loaded,
