...
\begin{docTcbKey}{lowerbox}{=\meta{mode}}{no default, initially \texttt{visible}}
  ...
  \begin{marker}
  The lower part is always typset into a box which is used or dropped
...
\begin{docTcbKey}{savedelimiter}{=\meta{name}}{no default, initially \texttt{tcolorbox}}
  ...
  |tcolorbox| and use or allow the option \refKey{/tcb/savelowerto}
  or~\refKey{/tcb/redirectlowerto}.
