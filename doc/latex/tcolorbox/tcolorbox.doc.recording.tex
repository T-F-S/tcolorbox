...
\zvref{sec:recording-exercises} where
information about example solutions is recorded and read again
in \zvref{sec:recording-solutions}.
...
\begin{docCommand}[doc new=2014-11-28]{tcbstartrecording}{\oarg{file name}}
  ...
  See \zvref{sec:recording-exercises} for an example application.
  \begin{marker}
...
has no solution. Finally, the solutions are input in \zvref{sec:recording-solutions}.
...
This concludes the example given in \zvref{sec:recording-exercises}.
