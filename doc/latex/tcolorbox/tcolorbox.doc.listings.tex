...
\begin{dispListing*}{title={Do not use this},fonttitle=\bfseries}
\DeclareTCBListing{mybox}{ O{} }{listing only,#1}
...
See further options in \zvref{sec:commonlistingkeys}.

\begin{marker}
For a combined example of using |\lstinline| inside a \refEnv{tcolorbox}, see
...
all options from \zvref{sec:speclistingkeys} are applicable.
...
\begin{docTcbKey}[][doc updated=2024-11-07]{minted style}{=\meta{style}}{no default, initially unset}
Sets a \meta{style} known to |Pygments| \cite{pygments:web}, see \url{https://pygments.org/styles/}.
Alternatively, one could add |style=|\meta{style} to \refKey{/tcb/minted options}.
Note that
...
\begin{marker}
Up to version 6.4.1, \refKey{/tcb/minted style} applied |\usemintedstyle|\marg{style}
resulting in a global style change, even for code using \refPkg{minted} directly.
Now, \refKey{/tcb/minted style} only applies to |tcolorbox|.
\end{marker}
...
\clearpage
\begin{docTcbKey}[][doc new=2025-05-20]{run pdflatex-dev}{\colOpt{=\meta{arguments}}}{style, no default, initially unset}
Issues a |pdflatex-dev| compilation of the listing with the given \meta{arguments}.
\end{docTcbKey}
...
\begin{docTcbKey}[][doc new=2025-05-20]{run xelatex-dev}{\colOpt{=\meta{arguments}}}{style, no default, initially unset}
Issues a |xelatex-dev| compilation of the listing with the given \meta{arguments}.
\end{docTcbKey}
...
\begin{docTcbKey}[][doc new=2025-05-20]{run lualatex-dev}{\colOpt{=\meta{arguments}}}{style, no default, initially unset}
Issues a |lualatex-dev| compilation of the listing with the given \meta{arguments}.
\end{docTcbKey}
...
See the \refPkg{makeindex} documentation for more information.
\end{docTcbKey}
...
See the \refPkg{bibtex} documentation for more information.
\end{docTcbKey}
...
See the \refPkg{biber} documentation for more information.
\end{docTcbKey}
...
See the \refPkg{arara} documentation for more information.
\end{docTcbKey}

\begin{docTcbKey}[][doc new=2025-05-20]{run latexmk}{\colOpt{=\meta{arguments}}}{style, no default, initially unset}
Issues a |latexmk| compilation of the listing with the given \meta{arguments}.
See the \refPkg{latexmk} documentation for more information.
\end{docTcbKey}
...
\begin{docTcbKey}[][doc new=2025-05-20]{run latex-dev}{\colOpt{=\meta{arguments}}}{style, no default, initially unset}
Issues a |latex-dev| compilation of the listing with the given \meta{arguments}.
\end{docTcbKey}
...
See the \refPkg{dvips} documentation for more information.
\end{docTcbKey}
...
|solutions|. Also see \zvref{sec:recording}.
