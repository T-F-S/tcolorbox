...
\clearpage
\begin{docTcbKey}[][doc updated=2024-11-26]{sidebyside align}{=\meta{alignment}}{no default, initially |center|}
  ...
  \item\docValue{top}:    identical to |minipage| option |t| (aligns the top
    ...
    \begin{marker}
    This value of \meta{alignment} needs \refPkg{luacolor} to work properly since version 6.0.0 (2023-02-10).
    Adding |\strut| may help alternatively to simulate the effect for equal font heights.
    \end{marker}
...
methods from \zvref[S]{subsec:sidebyside_xparse}.
