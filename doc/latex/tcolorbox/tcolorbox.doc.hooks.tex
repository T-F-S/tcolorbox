...
\begin{docTcbKey}{overlay first and middle app}{=\meta{graphical code}}{no default}
  Appends the given \meta{graphical code} to \refKey{/tcb/overlay first and middle}.
\end{docTcbKey}

\begin{docTcbKey}{overlay first and middle pre}{=\meta{graphical code}}{no default}
...
\begin{docTcbKey}{underlay first and middle pre}{=\meta{graphical code}}{no default}
...
\begin{docTcbKey}{finish first and middle pre}{=\meta{graphical code}}{no default}
