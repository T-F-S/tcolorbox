...
\item\tcbdocmarginnote{\tcbdocnew{2016-05-25}}
  ...
  the \mylib{breakable} library contains a patch for this which is activated
  by including the |ifluatex| package \emph{\bfseries before} \mylib{breakable} is loaded.
\end{itemize}
