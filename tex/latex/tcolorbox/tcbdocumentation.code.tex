%% The LaTeX package tcolorbox - version 6.2.0pre5 (2023/12/08)
...
%%
\tcb@set@library@version{6.2.0pre5}
...
\cs_new:Npn \__tcobox_doc_head_key:
  {
    ...
    \tl_if_empty:NTF \kvtcb@doc@keypath
      ...
      {
        \tl_set:Nx \l__tcobox_tmpa_tl {\kvtcb@doc@keyprefix\kvtcb@doc@keypath/\kvtcb@doc@label}
        \seq_if_in:NVF \g__tcobox_label_seq \l__tcobox_tmpa_tl
          {
            ...
            \seq_gput_left:NV \g__tcobox_label_seq \l__tcobox_tmpa_tl
          }
      }
    {\ttfamily\kvtcb@doc@parameter}
    \tcb@doc@do@description
