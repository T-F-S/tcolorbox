%% The LaTeX package tcolorbox - version 6.6.0pre1 (2025/05/28)
...
%%
\tcb@set@library@version{6.6.0pre1}
...
\tcbset{%
  ...
  temporal/.code args={<#1>#2#3#4}{\temporal<#1>{\tcbset{#2}}{\tcbset{#3}}{\tcbset#4}},% possible beamer error with #1 (?!)
