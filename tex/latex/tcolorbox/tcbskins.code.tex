%% The LaTeX package tcolorbox - version 6.10.0pre1 (2026/03/05)
...
%%
\tcb@set@library@version{6.10.0pre1}
...
\tl_new:N \l__tcobox_beamer_temporal_args
\tl_new:N \l__tcobox_beamer_alt_args
...
\tcbset{
  ...
  set~alt /.code =
    {
      \tl_set:Nn \l__tcobox_beamer_alt_args { #1 }
    },
  set~alt = {}{},
  use~alt /.code =
    {
      \use:e
        {
          \__tcobox_beamer_alt:w \exp_not:n { #1 } \exp_not:o \l__tcobox_beamer_alt_args
        }
    },
  set~temporal /.code =
    {
      \tl_set:Nn \l__tcobox_beamer_temporal_args { #1 }
    },
  set~temporal = {}{}{},
  use~temporal /.code =
    {
      \use:e
        {
          \__tcobox_beamer_temporal:w \exp_not:n { #1 } \exp_not:o \l__tcobox_beamer_temporal_args
        }
    },
}
