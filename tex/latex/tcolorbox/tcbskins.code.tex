%% The LaTeX package tcolorbox - version 6.6.0pre2 (2025/05/29)
...
%%
\tcb@set@library@version{6.6.0pre2}
...
\tcbset{
  alt     /.code~args = { <#1>#2 }{ \__tcobox_beamer_alt:nnn #1#2 },
  temporal/.code~args = { <#1>#2 }{ \__tcobox_beamer_temporal:nnnn #1#2 },
}

\cs_new:Npn \__tcobox_beamer_alt:nnn #1#2#3
  {
    \alt <#1> { \tcbset{#2} }{ \tcbset{#3} }
  }

\cs_new:Npn \__tcobox_beamer_temporal:nnnn #1#2#3#4
  {
