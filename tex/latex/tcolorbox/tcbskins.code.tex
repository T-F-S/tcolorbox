...
\tcbset{
  ...
  use~alt /.code =
    {
      \tl_set:Nn \l__tcobox_tmpa { #1 }
      \exp_last_two_unbraced:Noo \__tcobox_beamer_alt:w \l__tcobox_tmpa \l__tcobox_beamer_alt_args
    },
  set~temporal /.code =
    {
  ...
  use~temporal /.code =
    {
      \tl_set:Nn \l__tcobox_tmpa { #1 }
      \exp_last_two_unbraced:Noo \__tcobox_beamer_temporal:w \l__tcobox_tmpa \l__tcobox_beamer_temporal_args
    },
}
