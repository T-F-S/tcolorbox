%% The LaTeX package tcolorbox - version 3.92pre1 (2016/05/25)
...
%%
\tcb@set@library@version{3.92pre1}
...
% patch for luatex 0.95
% needs package 'ifluatex' to be loaded before 'breakable' is loaded
\ifcsdef{ifluatex}{\ifluatex\ifnum\luatexversion=95\relax%
  \def\tcb@vsplit@upper{%
    \directlua{%
