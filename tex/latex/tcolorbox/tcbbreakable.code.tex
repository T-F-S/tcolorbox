%% The LaTeX package tcolorbox - version 3.12pre1 (2014/07/28)
...
%%
\tcb@set@library@version{3.12pre1}
  ...
  \else
    \iftcb@break@allowed%
      \ifdim\dimexpr\tcb@h@page-\tcb@h@padding-\tcb@h@padtitle<\kvtcb@breakminlines\baselineskip\relax%
        ...
        %\iftcb@multicol\columnbreak\else\eject\fi%
...
\def\tcb@setbox@upper#1#2{%
  ...
  \setbox\tcb@upperbox=\vbox{\unvbox#2}%
...
\def\tcb@setbox@lower#1#2{%
  ...
  \setbox\tcb@lowerbox=\vbox{\unvbox#2}%
...
\def\tcb@split@first{%
  ...
  \ifx\kvtcb@float\@empty%
    ...
    \else%
      ...
      %\long\def\tcb@after@first{\eject\tcb@enlbreak@next}%
    \fi%
