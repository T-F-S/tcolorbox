%% The LaTeX package tcolorbox - version 5.1.2pre1 (2023/01/27)
...
%%
%\makeatletter
\tcb@set@library@version{5.1.2pre1}
...
\def\tcb@fit@@box{%
  \iftcb@hasTitle%
    ...
    \begin{tcb@savebox}{\tcb@titlebox}{\tcb@w@title}{tcbcoltitle}\kvtcb@fonttitle\kvtcb@haligntitle\kvtcb@before@title\kvtcb@title\kvtcb@after@title\end{tcb@savebox}%
