...
%% tcbminted.code.tex: Code for colorboxes with minted
%%
%% -------------------------------------------------------------------------------------------
...
\cs_new_protected_nopar:Npn \__tcobox_minted_input_listing:nnnn #1#2#3#4
  {
...
\cs_new_protected_nopar:Npn \__tcbbox_minted_uselistinglisting:
  {
...
\cs_new_protected_nopar:Npn \__tcbbox_minted_usetemplisting:
  {
    \__tcobox_minted_input_listing:VVVV
      \kvtcb@minted@options
      \kvtcb@minted@language
...
\cs_new_protected_nopar:Npn \__tcbbox_minted_doc_usetemplisting:
  {
    \__tcobox_minted_input_listing:VVVV
